...
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\time.h" 1 3



# 1 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8\\pic\\include\\__unsupported.h" 1 3
# 4 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\time.h" 2 3
...
# 47 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\time.h" 3
...
void main(void) {
    ...
    char sendpacket[19];
    char examplepacket[] = "100/200/0/12345";
    char receivedpacket[] = "";
    char *ptr = examplepacket;
    char idpic[] = "99";
    char idgateway[] = "200";
    char sep = '/';
    char inviofrompic = '0';
...
# 139 "newmain.c"
        ...
        if (read == '*' && richiesta == 0) {
            ...
            Lcd_Set_Cursor(0, 3);
            Lcd_Write_Int(numrand);
# 153 "newmain.c"
            sprintf(payload, "%d", numrand);
            sprintf(sendpacket, "%s%c%s%c%c%c%s%c", idpic, sep, idgateway, sep, inviofrompic, sep, payload, endpacket);
            UART_TxString(sendpacket);
            richiesta = 1;

        } else if (richiesta == 1 && received) {
            Lcd_Clear();
            Lcd_Set_Cursor(0, 3);
...
void UART_init(long int baudrate) {
    ...
    TXSTA |= 0x24;
    RCSTA = 0x90;
    SPBRG = (char) (8*1000000 / (long) (64UL * baudrate)) - 1;
    INTCON |= 0x80;
    INTCON |= 0x40;
    PIE1 |= 0x20;
}
...
void Lcd_Port(char a) {
    ...
    if (a & 1) PORTDbits.RD4 = 1;
    else PORTDbits.RD4 = 0;

    if (a & 2) PORTDbits.RD5 = 1;
    else PORTDbits.RD5 = 0;

    if (a & 4) PORTDbits.RD6 = 1;
    else PORTDbits.RD6 = 0;

    if (a & 8) PORTDbits.RD7 = 1;
...
void Lcd_Cmd(char a) {
    ...
    Lcd_Port(a);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((4)*(8*1000000/4000.0)));
    PORTEbits.RE1 = 0;
}
...
void Lcd_Init() {
    ...
    TRISE &= ~0x06;
    Lcd_Port(0x00);
    _delay((unsigned long)((20)*(8*1000000/4000.0)));
    Lcd_Cmd(0x03);
    _delay((unsigned long)((5)*(8*1000000/4000.0)));
    Lcd_Cmd(0x03);
    _delay((unsigned long)((10)*(8*1000000/4000.0)));
    Lcd_Cmd(0x03);
...
void Lcd_Write_Char(char a) {
    ...
    Lcd_Port(y >> 4);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((4)*(8*1000000/4000000.0)));
    PORTEbits.RE1 = 0;
    Lcd_Port(temp);
    PORTEbits.RE1 = 1;
    _delay((unsigned long)((4)*(8*1000000/4000000.0)));
...
char Numpad_Read() {
    ...
    for (colScan = 0; colScan < 3; colScan++) {
        PORTB |= 0x07;
        PORTB &= ~(1 << colScan);
        _delay((unsigned long)((15)*(8*1000000/4000.0)));
        for (rowScan = 0; rowScan < 4; rowScan++) {
            currentKeyVal = (PORTD & (1 << rowScan));
